...
const ShareButton: React.FC<ShareButtonProps> = ({ 
  ...
  const socialShareLinks = [
    ...
    {
      name: 'X',
      url: `https://x.com/intent/tweet?text=${encodeURIComponent(truncateForTwitter(description))}`,
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div 
          className="absolute top-full mt-2 bg-white shadow-lg rounded-lg p-4 w-64 z-10"
              ...
              if (link.action) {
                return (
                  ...
                  >
                    ...
                    {copied && (
                      <span 
                        className="absolute -top-2 -right-2 bg-green-500 text-white rounded-full w-4 h-4 
                        flex items-center justify-center text-xs animate-ping"
                      >
                        ✓
                      </span>
                    )}
